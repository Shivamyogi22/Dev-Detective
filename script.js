...
function updateProfile(data) {
    if (data.message !== "Not Found") {
        ...
        userName.innerText = data.name === null ? data.login : data.name; //it is a tranry operator that says given condition is true than go for 1st cinditon else go for second condition
